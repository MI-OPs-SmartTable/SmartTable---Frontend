...
export const DASHBOARD_NAV_ITEMS = [
  { id: "/dashboard", label: "Dashboard", icon: DASHBOARD_ICONS.grid, roles: ["admin", "cajero", "mesero"] },
  { id: "/dashboard/ventas", label: "Ventas", icon: DASHBOARD_ICONS.cart, roles: ["admin", "cajero", "mesero"] },
  { id: "/dashboard/productos", label: "Productos", icon: DASHBOARD_ICONS.box, roles: ["admin"] },
  { id: "/dashboard/caja", label: "Caja", icon: DASHBOARD_ICONS.cash, roles: ["admin", "cajero"] },
  { id: "/dashboard/configuracion", label: "Configuración", icon: DASHBOARD_ICONS.config, roles: ["admin"] },
];
