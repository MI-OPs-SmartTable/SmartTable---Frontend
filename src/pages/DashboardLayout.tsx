...
const NAV_ITEMS = [
  ...
  { id: "/dashboard/ventas", label: "Ventas / POS", icon: Ic.cart },
  { id: "/dashboard/productos", label: "Productos", icon: Ic.box },
  { id: "/dashboard/caja", label: "Caja", icon: Ic.cash },
];
...
export default function DashboardLayout() {
  ...
  const currentTitle = NAV_ITEMS.find(i => i.id === location.pathname)?.label || "Dashboard";
  ...
  return (
    <div className="db-root">
      <aside className="db-sidebar">
        ...
        <div className="db-caja-closed">
          <div className="db-caja-dot" />
          Caja cerrada
        </div>
        ...
        <div className="db-user" onClick={handleLogout}>
          ...
          <div>
            <div className="db-user-name">Administrador</div>
      ...
      <main className="db-main">
        <div className="db-page-title">{currentTitle}</div>
        <div className="db-page-sub">Hoy es {today}</div>
        <Outlet />
      </main>
    </div>
  );
