/** Presentación UI por nombre de categoría (no persiste en SQLite). */
const UI_BY_NOMBRE: Record<string, { color: string; emoji: string }> = {
  ...
  "Platos fuertes": { color: "#2d7a4f", emoji: "🍽️" },
